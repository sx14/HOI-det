...
if __name__ == '__main__':
  ...
  if args.resume:
    load_name = os.path.join(output_dir,
      'ho_spa_rcnn3_lf_no_nis_vrb_sft_glb_dp_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    save_name = os.path.join(output_dir, 'ho_spa_rcnn3_lf_no_nis_vrb_sft_glb_dp_{}_{}_{}.pth'.format(args.session, epoch, step))
    save_checkpoint({
