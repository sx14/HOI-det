...
if __name__ == '__main__':
  ...
  if args.resume:
    load_name = os.path.join(output_dir,
      'ho_spa_rcnn3_lf_no_nis_vrb_sft_glb_roi_{}_{}_{}.pth'.format(args.checksession, args.checkepoch, args.checkpoint))
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    for step in range(iters_per_epoch):
      ...
      hoi_classes.resize_(data[6].size()).copy_(data[6])
      vrb_classes.resize_(data[7].size()).copy_(data[7])
      bin_classes.resize_(data[8].size()).copy_(data[8])
      hoi_masks.resize_(data[9].size()).copy_(data[9])
    ...
    save_name = os.path.join(output_dir, 'ho_spa_rcnn3_lf_no_nis_vrb_sft_glb_roi_{}_{}_{}.pth'.format(args.session, epoch, step))
    save_checkpoint({
