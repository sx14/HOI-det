...
if __name__ == '__main__':
  ...
  # output_path = os.path.join(output_dir, 'all_hoi_detections_2019_with_yolo.json')
  output_path = os.path.join(output_dir, 'all_hoi_detections_2019_with_yolo_no_aug_avg_fuse_pose.json')

  print('Loading object detections ...')
  # det_path = '/home/magus/data/C0008-challenge/object_detection_results/yolo_2019test_with_image_id.json'
  det_path = '/home/magus/data/C0008-challenge/pose_results/yolo_2019test_with_pose_with_image_id.json'
  # det_path = '/home/magus/data/C0008-challenge/sunx-workspace/ResNeSt/output_resnest200/inference/coco_instances_results_with_image_id.json'
  ...
  # all_results = []
  all_hoi_res = []
  image_path_template = 'data/hoia/test/%s'
